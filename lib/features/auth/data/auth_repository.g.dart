...
class _IAuthRepository implements IAuthRepository {
  _IAuthRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<dynamic> getCallback(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
